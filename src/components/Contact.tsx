...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-white dark:bg-gray-900 relative overflow-hidden">
      ...
      <div className="absolute right-0 bottom-0 w-64 h-64 bg-blue-100 dark:bg-blue-900/20 rounded-full opacity-50 -z-10 transform translate-x-1/4 translate-y-1/4"></div>
      <div className="absolute left-0 top-0 w-48 h-48 bg-indigo-100 dark:bg-indigo-900/20 rounded-full opacity-50 -z-10 transform -translate-x-1/4 -translate-y-1/4"></div>
              ...
              {submitted ? (
                ...
                <form ref={formRef} onSubmit={handleSubmit}>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors flex items-center justify-center font-medium disabled:bg-blue-400 dark:disabled:bg-blue-700 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
